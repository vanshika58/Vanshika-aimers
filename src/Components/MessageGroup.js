...
const MessageGroup = () => {
  ...
  return (
    ...
    <div style={{ display: "flex", flexDirection: "row" ,width:"100%"}}>
        <div style={{ width: "30%", margin: "3%" , height:'100%' }}>  <div className="d-flex flex-row">
  ...
  <Link  style={{padding:'3%'}} className="fw-bold " to="/messagebatch"><MDBIcon className="p-4" fas icon="user-friends" /></Link>
        ...
        <div className="d-flex flex-row p-3  ">
                      ...
                      />
                      <div className="p-3">
                      <Link to="messagegroup" className="fw-bold mb-0" style={{color:'black' ,fontSize:'xx-larger'}}>Post graducation certification program in managment</Link>
                        <p className="small text-muted">
                         Batch 1A
                        </p>
                      </div>
          ...
          <MDBCardBody style={{height:'70%'}} >
                <div className="d-flex flex-row justify-content-start">
                  ...
                  <div>
                    <p
                      className="small p-3 ms-3 mb-1 rounded-3"

...
const CourseFinal = () => {
  ...
  return (
    ...
    <div style={{ display: "flex", flexDirection: "row" ,width:"100%"}}>
      <div style={{width:'100%'}}>
         <img className="p-3" style={{width:'40%', alignItems:'center'}} src="final.jpg"/>
         <h3 style={{textAlign:'center'}}>Congratulations</h3>
         <p style={{textAlign:'center'}}>You completed the course</p>
         <Button style={{textAlign:'center'}}  variant="primary" size="lg" active>
        Back to course
      </Button>{' '} </div>
    </div> <br></br>

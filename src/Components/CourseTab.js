...
<div class="col"> <div class="card" >
  ...
  <pre>  <img src='star.png' style={{height:'30px',width:'30px', fontWeight:'bolder'}}/> 4.8                  2,000</pre>
        ...
        <div
          className={toggleState === 4 ? "content  active-content" : "content"} style={{padding:"3%"}}
        >
          <div className="card p-3"  style={{width:'50%'}}>
          <h2 >This Course Includes:</h2>
          <p>104 hour on demand study video</p>
          <p>3 studdy material full lifetime acces</p>
        <p>Certificate of completion</p>
          <Row><Col sm={3}>Price: 2,000</Col><Col>1,000 - 50% off</Col></Row>
        </div></div>
      </div>
    </div>
  );
